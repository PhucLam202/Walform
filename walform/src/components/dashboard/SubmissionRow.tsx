...
export function SubmissionRow({ index, blobId, formId, onViewDetail }: SubmissionRowProps) {
  ...
  return (
    <article className="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[#91e0da] hover:shadow-lg">
      ...
      <button
        ...
        className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#124741] py-2.5 text-sm font-extrabold text-white transition hover:bg-[#0d302c]"
      >
